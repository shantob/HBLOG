                        ...
                        <div className="col">
                            {a.map(i => {
                                return <Link className='corcer-pointer link' key="{i}">
                                    <div className="d-flex row rounded hover my-2 mx-1" style={{ backgroundColor: '#2c2626' }}>
                                        ...
                                        <div className="col-md-3">
                                            <div className="d-flex justify-content-end">
                                                <p className='text-light me-3'>
                                                    <button className="btn btn-dark mt-3 dropdown-toggle" type="button" data-bs-toggle="dropdown" >
                                                        <i className="fa fa-ellipsis-v" aria-hidden="true"></i>
                                                    </button>
                                                    <ul className="dropdown-menu bg-dark ">
                                                        <li><a className="dropdown-item text-light" href="#">Unfriend</a></li>
                                                        <li><a className="dropdown-item text-light" href="#">Unfolow</a></li>
                                                        <li><a className="dropdown-item text-light" href="#">BLock</a></li>
                                                    </ul>
                                                </p>
                                            </div>
                                        </div>
